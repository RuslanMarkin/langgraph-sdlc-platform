...
менять их режим. После применения запускается фиксированная команда
`pnpm check`; только успешный результат может быть закоммичен и отправлен в
draft PR. Результат, версия prompt и вызов модели видны в Langfuse.
